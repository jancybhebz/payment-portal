    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "Online Payment",
            "url": "https://payments.paete.gov.ph"
        }
    </script>
...
<body style="background: url(&quot;https://ticketing.paete.gov.ph/uploads/1715737800_FB%20COVERS2.png&quot;);">
    <nav class="navbar navbar-expand-md bg-dark py-3" data-bs-theme="dark">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    </svg></span><span>PAETEGOVPH</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2 style="color: var(--bs-body-bg);font-weight: bold;font-size: 40px;">ONLINE PAYMENT PORTAL</h2>
                <p class="w-lg-50" style="color: var(--bs-body-bg);">Curae hendrerit donec commodo hendrerit egestas tempus, turpis facilisis nostra nunc. Vestibulum dui eget ultrices.</p>
            </div>
        </div>
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div class="col">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="images/realpropicon.png">
    ...
    <footer class="text-center py-4" style="background: var(--bs-body-bg);">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3">
                <div class="col">
                    <p class="text-muted my-2">Copyright&nbsp;© 2024 PAETEGOVPH</p>
                </div>
                <div class="col">
